                    ...
                    <ul class="tree-1">
                        ...
                        <li class="nav-sub-item has-class"><a href="#">JSON Form</a>
                            <ul class="tree-2">
                                ...
                                <li class="has-class"><a href="../json-forms/customer-profile-edit-form.html">Profile Edit</a></li>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Customer Profile - Edit Form</h5>
...
<![endif]-->
        ...
        <script type="text/javascript" src="../assets/pages/json-forms/js/customer-profile-edit-form.js"></script>
        <!--color script-->
