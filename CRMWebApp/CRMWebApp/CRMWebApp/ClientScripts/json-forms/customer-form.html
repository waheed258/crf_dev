                    ...
                    <ul class="tree-1">
                        ...
                        <li class="nav-sub-item has-class"><a href="#">JSON Form</a>
                            <ul class="tree-2">
                                ...
                                <li class="has-class"><a href="../json-forms/customer-form.html">Customer Form</a></li>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <span>This example loads options and schema parameters through ajax calls.</span>
                            </div>
                            <div class="card-block">
                                <div id="form1"></div>
                                <h5>Notes:</h5>
                                <span>Add street, city and zip code based on state selection.</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<![endif]-->
        ...
        <script type="text/javascript" src="../assets/pages/json-forms/js/customer-form.js"></script>
        <!--color script-->
