                    ...
                    <ul class="tree-1">
                        ...
                        <li class="nav-sub-item has-class"><a href="#">JSON Form</a>
                            <ul class="tree-2">
                                ...
                                <li class="has-class"><a href="../json-forms/localized-login.html">Localized Login</a></li>
                            </ul>
                        </li>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Localized Login Demo</h5>
                                <span>The form below provides a localized login form in Spanish. It uses the es_ES local to render the form in Spanish using the configuration shown. It also hooks in a custom validation and submission handler.</span>
                            </div>
                            <div class="card-block">
                                <div id="form5"></div>
                            </div>
...
<![endif]-->
        ...
        <script type="text/javascript" src="../assets/pages/json-forms/js/localized-login.js"></script>
        <!--color script-->
