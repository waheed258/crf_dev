...
<head>
    ...
    <!-- alpaca.css -->
    <link rel="stylesheet" type="text/css" href="../assets/pages/alpaca/alpaca.css">
    <!-- Style.css -->
                    ...
                    <ul class="tree-1">
                        ...
                        <li class="nav-sub-item has-class"><a href="#">JSON Form</a>
                            <ul class="tree-2">
                                ...
                                <li class="has-class"><a href="../json-forms/registration-click-validation.html">Registration Validation</a></li>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Registration Form with Click Validation</h5>
                                <span>This form expands the three-field registration form to include manual submit validation. The state of the submit button does not change as the values of the form are filled out. However, once the submit button is clicked, we manually handle some validation and take care of submitting the form on our own.</span>
                            </div>
                            <div class="card-block">
                                <div id="form7"></div>
                            </div>
...
<![endif]-->
        ...
        <script type="text/javascript" src="../assets/pages/json-forms/js/registration-click-validation.js"></script>
        <!--color script-->
