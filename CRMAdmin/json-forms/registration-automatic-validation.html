                    ...
                    <ul class="tree-1">
                        ...
                        <li class="nav-sub-item has-class"><a href="#">JSON Form</a>
                            <ul class="tree-2">
                                ...
                                <li class="has-class"><a href="../json-forms/registration-automatic-validation.html">Automatic Validation</a></li>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Registration Form with Automatic Validation</h5>
                                <span>Here is a very simple example of a three-field registration form. The submit button is not available until all of the fields have been filled in and are in a valid state.</span>
                            </div>
                            <div class="card-block">
                                <div id="form6"></div>
                            </div>
...
<![endif]-->
    ...
    <script type="text/javascript" src="../assets/pages/json-forms/js/registration-automatic-validation.js"></script>
    <!--color script-->
