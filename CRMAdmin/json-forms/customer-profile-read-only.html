                    ...
                    <ul class="tree-1">
                        ...
                        <li class="nav-sub-item has-class"><a href="#">JSON Form</a>
                            <ul class="tree-2">
                                ...
                                <li class="has-class"><a href="../json-forms/clubs.html">Clubs(View Selector)</a></li>
                                ...
                                <li class="has-class"><a href="../json-forms/customer-profile-read-only.html">Profile Ready Only</a></li>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Customer Profile - Edit Form (Read Only)</h5>
                                <span>This example loads data, options and schema parameters through ajax calls.</span>
                            </div>
                            <div class="card-block">
                                <div id="form4"></div>
                            </div>
...
<![endif]-->
        ...
        <script type="text/javascript" src="../assets/pages/json-forms/js/customer-profile-read-only.js"></script>
        <!--color script-->
