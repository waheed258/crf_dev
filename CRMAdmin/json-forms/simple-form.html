                ...
                <li class="nav-item has-class">
                    ...
                    <ul class="tree-1">
                        ...
                        <li class="nav-sub-item has-class"><a href="#">JSON Form</a>
                            <ul class="tree-2">
                                <li class="has-class"><a href="../json-forms/simple-form.html">Simple Form</a></li>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Simple form</h5>
                                <span>This form loaded using AMD and Require.js.You can click on submit button and then shows a json data.</span>
                            </div>
                            <div class="card-block">
                                <div id="form"></div>
                            </div>
...
<![endif]-->
    ...
    <script type="text/javascript" src="../assets/pages/json-forms/js/simple-form.js"></script>
    <!--color script-->
