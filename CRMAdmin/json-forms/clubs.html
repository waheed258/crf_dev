                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h5>Clubs (View Selector)</h5>
                                <span>This demo lets you change views and select clubs to see how the formatting changes.</span>
                            </div>
                            <div class="card-block">
...
<![endif]-->
    ...
    <script type="text/javascript" src="../assets/pages/json-forms/js/clubs.js"></script>
</body>
