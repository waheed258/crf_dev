<%@ Page Title="" Language="C#" MasterPageFile="~/AdminForms/Layout.master" AutoEventWireup="true" CodeFile="ActivityLogList.aspx.cs" Inherits="AdminForms_ActivityLogList" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#target").keyup(function () {
                if ($("[id *=target]").val() != "") {
                    $("[id *=ContentPlaceHolder1_gvActivityLog]").children
                    ...
                    $("[id *=ContentPlaceHolder1_gvActivityLog]").children('tbody').
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="content-wrapper">
        ...
        <section class="content" id="ActivityLogList" runat="server">
            <div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-bd">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="gvActivityLog" runat="server" Width="100%"
                                    AutoGenerateColumns="False" CssClass="rounded-corners"
                                    EmptyDataText="There are no data records to display."
                                    BorderStyle="Solid" BorderWidth="0px" AllowPaging="true" PageSize="100" OnPageIndexChanging="gvActivityLog_PageIndexChanging" OnRowDataBound="gvActivityLog_RowDataBound" 
