<%@ Page Title="" Language="C#" MasterPageFile="~/AdminForms/Layout.master" AutoEventWireup="true" CodeFile="InvoiceReport.aspx.cs" Inherits="AdminForms_InvoiceReport" EnableEventValidation="false" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#target").keyup(function () {
                if ($("[id *=target]").val() != "") {
                    $("[id *=ContentPlaceHolder1_gvInvoiceReport]").children
                    ...
                    $("[id *=ContentPlaceHolder1_gvInvoiceReport]").children('tbody').
                    ...
                    <div class="panel panel-bd">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="gvInvoiceReport" runat="server" Width="100%"
                                    AutoGenerateColumns="False" CssClass="rounded-corners"
                                    EmptyDataText="There are no data records to display."
                                    BorderStyle="Solid" BorderWidth="0px" AllowPaging="true" PageSize="100" OnPageIndexChanging="gvInvoiceReport_PageIndexChanging" OnRowDataBound="gvInvoiceReport_RowDataBound"
