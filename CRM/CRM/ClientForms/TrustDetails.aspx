    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#targetTrustee").keyup(function () {
                if ($("[id *=target4]").val() != "") {
                    $("[id *=ContentPlaceHolder1_gvTrustee]").children
                    ('tbody').children('tr').each(function () {
                        $(this).show();
                    });
                    $("[id *=ContentPlaceHolder1_gvTrustee]").children
                    ('tbody').children('tr').each(function () {
                        var match = false;
                        $(this).children('td').each(function () {
                            if ($(this).text().toUpperCase().indexOf($("[id *=targetTrustee]").val().toUpperCase()) > -1) {
                                match = true;
                                return false;
                            }
                        });
                    ...
                    $("[id *=ContentPlaceHolder1_gvTrustee]").children('tbody').
                            children('tr').each(function (index) {
                                if (index == 0)
                                    $(this).show();
                            });
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <div class="col-sm-1 form-group" style="padding: 0px; margin-top: 14px;">
                                                    <asp:ImageButton ID="imgSearchsaid" runat="server" ImageUrl="~/assets/dist/img/search-icon.png" ValidationGroup="trust" Height="35" Width="35" ToolTip="Search" OnClick="imgSearchsaid_Click" />
                                                </div>
                                            </div>
                                            <div class="col-sm-3 form-group">
                                ...
                                <div class="tab-pane fade" id="tabTrustee">
                                    <div class="panel-body">
                                        <div class="row" id="divtrustee" runat="server">
                                            <div class="col-lg-12">
                                                <div class="col-lg-1 form-group">
                                                    <asp:DropDownList ID="dropTrustee" runat="server" CssClass="form-control"
                                                        OnSelectedIndexChanged="dropTrustee_SelectedIndexChanged"
                                                        AutoPostBack="true">
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="col-lg-2 form-group">
                                        ...
                                        <div class="table-responsive">
                                            <asp:GridView ID="gvTrustee" runat="server" Width="100%"
                                                ...
                                                BorderStyle="Solid" BorderWidth="0px" AllowPaging="true" PageSize="5" CellPadding="4" CellSpacing="2" Style="font-size: 100%;"
                                                ForeColor="Black" HeaderStyle-BackColor="#e8f1f3" OnPageIndexChanging="gvTrustee_PageIndexChanging">
                                                <PagerStyle CssClass="pagination_grid" />
                                                <Columns>
                                                        <asp:TemplateField HeaderText="S No.">
                                                            <ItemTemplate>
