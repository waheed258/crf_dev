...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function (event) {
            $("#ContentPlaceHolder1_txtTelephone,#ContentPlaceHolder1_txtFax,#ContentPlaceHolder1_txtPostalCode,#ContentPlaceHolder1_txtAccountNumber,#ContentPlaceHolder1_txtAccTelNum").bind('keypress', function (e) {
            ...
            $("ContentPlaceHolder1_txtTelephone,#ContentPlaceHolder1_txtFax,#ContentPlaceHolder1_txtPostalCode,#ContentPlaceHolder1_txtAccountNumber,#ContentPlaceHolder1_txtAccTelNum").bind('mouseenter', function (e) {
                var val = $(this).val();
                if (val != '0') {
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-sm-3 form-group">
                                                <div class="col-sm-11" style="padding: 0px;">
                                                    ...
                                                    <asp:RegularExpressionValidator ID="rgvUIC" runat="server" ErrorMessage="Please enter 13 digits" ValidationExpression="[a-zA-Z0-9!@#$%^&*()/]{13}" Display="Dynamic"
                                                ...
                                                <div class="col-sm-1 form-group" style="padding: 0px; margin-top: 14px;">
                                                    <asp:ImageButton ID="imgSearchsaid" runat="server" ImageUrl="~/assets/dist/img/search-icon.png" ValidationGroup="Company" Height="35" Width="35" ToolTip="Search" OnClick="imgSearchsaid_Click" />
                                                </div>
                                            </div>
                                            <div class="col-sm-3 form-group">
                                            ...
                                            <div class="col-sm-3 form-group">
                                                <label class="control-label">Year of Company Foundation</label><%--<span class="style1">*</span>--%>
                                            ...
                                            <div class="col-sm-3 form-group">
                                                <label class="control-label">VAT Number</label><%--<span class="style1">*</span>--%>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="table-responsive">
                                                <asp:GridView ID="gvCompany" runat="server" Width="100%"
                                                    ...
                                                    CellPadding="4" CellSpacing="2" Style="font-size: 100%;" ForeColor="Black" HeaderStyle-BackColor="#e8f1f3" OnRowCommand="gvCompany_RowCommand" OnRowDataBound="gvCompany_RowDataBound">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Company Registartion #">
                                                            <ItemTemplate>
                                            ...
                                            <div class="col-md-12 form-group user-form-group">
                                                <div class="panel-body">
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-4 form-group">
                                                            <div class="col-sm-11" style="padding: 0px;">
                                                                ...
                                                                <asp:TextBox ID="txtvalidRegNum" CssClass="form-control" runat="server" ReadOnly="true" MaxLength="13"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 form-group">
                                                            <label class="control-label">Company Name</label>
                                                        ...
                                                        <div class="col-sm-4 form-group">
                                                            ...
                                                            <asp:TextBox ID="txtValidYCF" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-4 form-group">
                                                        ...
                                                        <div class="col-sm-4 form-group">
                                                            ...
                                                            <asp:TextBox ID="txtValidTelnum" CssClass="form-control" runat="server" ReadOnly="true" MaxLength="10"></asp:TextBox>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-4 form-group">
                                                            <label class="control-label">Website</label>
                                                            <asp:TextBox ID="txtvalidWebsite" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
