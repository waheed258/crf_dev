...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        $(document).ready(function (event) {
            $("#ContentPlaceHolder1_txtSAID,#ContentPlaceHolder1_txtMobile,#ContentPlaceHolder1_txtUIC,#ContentPlaceHolder1_txtPostalCode,#ContentPlaceHolder1_txtAccountNumber").bind('keypress', function (e) {
            ...
            $("#ContentPlaceHolder1_txtSAID,#ContentPlaceHolder1_txtMobile,#ContentPlaceHolder1_txtUIC,#ContentPlaceHolder1_txtPostalCode,#ContentPlaceHolder1_txtAccountNumber").bind('mouseenter', function (e) {
                var val = $(this).val();
                if (val != '0') {
                        ...
                        <div class="panel-body" id="Tabs">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="tabTrust">
                                    <div class="panel-body">
                                        <div class="col-sm-12">
                                            <div class="col-sm-3 form-group">
                                                <label class="control-label">Trust Registration Number</label><span class="style1">*</span>
                                                <asp:TextBox ID="txtUIC" CssClass="form-control" runat="server" ReadOnly="true" placeholder="Trust Registration Number" MaxLength="13"></asp:TextBox>
                                            ...
                                            <div class="col-sm-1" style="padding: 0px; margin-top: 14px;">
                                                <asp:ImageButton ID="imgSearchsaid" runat="server" ValidationGroup="trust" ImageUrl="~/assets/dist/img/search-icon.png" Height="35" Width="35" ToolTip="Search" OnClick="imgSearchsaid_Click" />
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvTitle" runat="server" ControlToValidate="ddlTitle" Display="Dynamic" ErrorMessage="Please Select Title"
                                                    ValidationGroup="trust" ForeColor="Red" InitialValue=""></asp:RequiredFieldValidator>
                                            </div>
                                            <div class="col-sm-3 form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group col-sm-3">
                                                ...
                                                <%-- <asp:RequiredFieldValidator ID="rfvDateOfBirth" runat="server" ControlToValidate="txtDateOfBirth" Display="Dynamic"
                                                    ErrorMessage="Enter Date Of Birth" ValidationGroup="trust" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                            </div>
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <%--   <asp:RequiredFieldValidator ID="rfvtxtMobile" runat="server" ControlToValidate="txtMobile" Display="Dynamic"
                                                    ErrorMessage="Enter Mobile Number" ValidationGroup="trust" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                    ...
                                    <div class="panel panel-bd" id="divTrusteelist" runat="server">
                                        <div class="panel-heading">
                                            <div class="panel-title">
                                                ...
                                                <asp:GridView ID="gvTrustee" runat="server" Width="100%" OnRowDataBound="gvTrustee_RowDataBound"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="DOB">
                                                            <ItemTemplate>
                                                                <asp:Label runat="server" ID="lblDOB" Text='<%#Eval("DateOfBirth") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Validate">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="imgbtnValidate" runat="server" Width="23px" Height="23px" ImageUrl="~/assets/dist/img/tick.jpg"
                                                                    CommandName="Validate" ToolTip="Validate" CommandArgument='<%#Eval("TrusteeID") %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <%--  <asp:TemplateField HeaderText="Delete">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="btnDelete" runat="server" Width="23px" Height="23px" ImageUrl="~/assets/dist/img/Delete.png"
                                                                    CommandName="DeleteTrustee" ToolTip="Delete Trustee" CommandArgument='<%#Eval("TrusteeID") %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>--%>
                                                    </Columns>
                                                </asp:GridView>
                                        ...
                                        <div class="table-responsive">
                                            <asp:GridView ID="gdvBankList" runat="server" Width="100%"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Clent Identification #" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label runat="server" ID="lblReferenceSAID" Text='<%#Eval("ReferenceSAID") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                        ...
                                        <div class="panel-body">
                                            <div class="col-sm-12">
                                                <div class="col-sm-4 form-group">
                                                    ...
                                                    <asp:TextBox ID="txtSAIDAddress" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                                                </div>
                                                <div class="col-sm-8 form-group">
                                                    <label class="control-label">Trustee Name</label>
                                                    <asp:TextBox ID="txtTrusteeAddress" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                                                ...
                                                <div class="panel-body">
                                                    <div class="col-md-12">
                                                        <div class="form-group col-sm-4">
                                                            ...
                                                            <label class="control-label">Trust Registration#</label>
                                                            <asp:TextBox ID="txtvalidUIC" CssClass="form-control" runat="server" ReadOnly="true" MaxLength="13"></asp:TextBox>

                                                        </div>

                                                        <div class="form-group col-sm-4">
                                                            <label class="control-label">Identification Number</label>
                                                            <asp:TextBox ID="txtvalidSAID" CssClass="form-control" runat="server" MaxLength="13" ReadOnly="true"></asp:TextBox>
                                                        </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group col-sm-4">
                                                            ...
                                                            <asp:TextBox ID="txtvalidFirstName" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>

                                                        </div>

                                                        <div class="form-group col-sm-4">
                                                            <label class="control-label">Last Name</label>
                                                            <asp:TextBox ID="txtvalidLastName" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                                                        </div>

                                                        <div class="form-group col-sm-4">
                                                            <label class="control-label">Email Id</label>
                                                            <asp:TextBox ID="txtvalidEmailId" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group col-sm-4">
                                                        ...
                                                        <div class="form-group col-sm-4">
                                                            ...
                                                            <asp:TextBox ID="txtvalidMobile" CssClass="form-control" runat="server" MaxLength="10" ReadOnly="true"></asp:TextBox>
                                                        </div>
                                                        <div class="form-group col-sm-4">
                                                            <label>Phone</label>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group col-sm-4">
                                                            ...
                                                            <asp:TextBox ID="txtvalidTaxRefNo" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
