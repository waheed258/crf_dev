                                        ...
                                        <div class="col-sm-12">
                                           ...
                                           <%--     <asp:RequiredFieldValidator ID="rfvPhoneNo" runat="server" ControlToValidate="txtPhoneNo" Display="Dynamic"
                                            ...
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <asp:TextBox ID="txtDateofBirth" runat="server" autocomplete="off" CssClass="form-control" placeholder="Enter Date of Birth"></asp:TextBox>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="table-responsive">
                                            <asp:GridView ID="gvDocumentList" runat="server" Width="100%"
                                                ...
                                                EmptyDataText="There are no data records to display. Please add Document details." OnPageIndexChanging="gvDocument_PageIndexChanging" OnRowDataBound="gvDocumentList_RowDataBound"
