<%@ Page Title="" Language="C#" MasterPageFile="~/AdminForms/LayoutForClientProfile.master" AutoEventWireup="true" CodeFile="Company.aspx.cs" Inherits="ClientProfile_Company" %>
                                        ...
                                        <div class="col-sm-12">                                          
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <div class="col-sm-1 form-group" style="padding: 0px; margin-top: 14px;">
                                                    <asp:ImageButton ID="imgSearchsaid" runat="server" ImageUrl="~/assets/dist/img/search-icon.png" Height="35" Width="35" ToolTip="Search" ValidationGroup="Company" OnClick="imgSearchsaid_Click" />
                                                </div>
                                            </div>
                                            <div class="col-sm-3 form-group">
                                            ...
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <asp:TextBox ID="txtYearofFoundation" disabled="disabled" autocomplete="off" placeholder="Enter Year of Company Foundation" CssClass="form-control" runat="server"></asp:TextBox>
                                            ...
                                            <div class="table-responsive">
                                                <asp:GridView ID="gvCompany" runat="server" Width="100%"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="VATNo" Visible="false">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Share Holder">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="btnBeneficiary" runat="server" Width="23px" Height="23px" ImageUrl="~/assets/dist/img/Beneficiary.jpg"
                                                                    CommandName="EditBeneficiary" ToolTip="Share Holder Details" CommandArgument='<%#Eval("UIC") %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
