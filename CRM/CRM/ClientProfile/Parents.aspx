<%@ Page Title="" Language="C#" MasterPageFile="~/AdminForms/LayoutForClientProfile.master" AutoEventWireup="true" CodeFile="Parents.aspx.cs" Inherits="ClientProfile_Parents" %>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group col-sm-3">
                                                ...
                                                <div class="col-sm-1" style="padding: 0px; margin-top: 14px;">
                                                    <asp:ImageButton ID="imgSearchsaid" runat="server" ImageUrl="~/assets/dist/img/search-icon.png" Height="35" Width="35" ToolTip="Search" ValidationGroup="Parent" OnClick="imgSearchsaid_Click" />
                                                </div>
                                            </div>
                                            <div class="form-group col-sm-3">
                                                        ...
                                                        <asp:TemplateField HeaderText="Edit">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="btnEdit" runat="server" Width="23px" Height="23px" ImageUrl="~/assets/dist/img/edit_new.png"
                                                                    CommandName="Edit" ToolTip="Edit" CommandArgument='<%#Eval("ParentID") %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
