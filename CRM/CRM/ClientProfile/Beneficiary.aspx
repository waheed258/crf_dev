<%@ Page Title="" Language="C#" MasterPageFile="~/AdminForms/LayoutForClientProfile.master" AutoEventWireup="true" CodeFile="Beneficiary.aspx.cs" Inherits="ClientProfile_Beneficiary" %>
                                         ...
                                         <div class="col-sm-12">
                                            ...
                                            <div class="form-group col-sm-3">
                                                ...
                                                <asp:RequiredFieldValidator ID="rfvTitle" runat="server" ControlToValidate="ddlTitle" ForeColor="Red"
                                                    ErrorMessage="Please Select Title" ValidationGroup="Beneficiary" Display="Dynamic" InitialValue=""></asp:RequiredFieldValidator>
                                            </div>
                                            <div class="col-sm-3 form-group">
                                        ...
                                        <div class="table-responsive">
                                            <asp:GridView ID="gvAddress" runat="server" Width="100%"
                                                ...
                                                <Columns>
                                                    ...
                                                    <%-- <asp:TemplateField HeaderText="Company Reg#">
                                                        <ItemTemplate>
                                            ...
                                            <asp:GridView ID="gdvBankList" runat="server" Width="100%"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="SWIFT" Visible="false">
                                                      ...
                                                      <asp:TemplateField HeaderText="Type" Visible="false">
                                                        <ItemTemplate>
                                                            <asp:Label runat="server" ID="lblShareType" Text='<%#Eval("BenificiaryType") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Edit">
                                                        <ItemTemplate>
