                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <div class="col-sm-1" style="padding: 0px; margin-top: 14px;">
                                                    <asp:ImageButton ID="imgSearchsaid" runat="server" ImageUrl="~/assets/dist/img/search-icon.png" Height="35" Width="35" ToolTip="Search" ValidationGroup="Director" OnClick="imgSearchsaid_Click" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group col-sm-3">
                                                ...
                                                <asp:DropDownList ID="ddlTitle" runat="server" CssClass="form-control">
                                                 ...
                                                 <asp:RequiredFieldValidator ID="rfvTitle" runat="server" ControlToValidate="ddlTitle" ForeColor="Red"
                                                    ErrorMessage="Please Select Title" ValidationGroup="Director" Display="Dynamic" InitialValue=""></asp:RequiredFieldValidator>
                                            </div>
                                            <div class="col-sm-3 form-group">
