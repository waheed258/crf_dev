<%@ Page Title="" Language="C#" MasterPageFile="~/AdminForms/LayoutForClientProfile.master" AutoEventWireup="true" CodeFile="TrustSettlor.aspx.cs" Inherits="ClientProfile_TrustSettlor" %>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade in active" id="tabTrust">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-sm-12">
                                            <div class="col-sm-3 form-group">
                                                ...
                                                <asp:TextBox ID="txtTrustUIC" CssClass="form-control" ReadOnly="true" MaxLength="13" placeholder="Trust Registration Number" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="col-sm-3 form-group">

                                                <label class="control-label">Identification Number</label><span class="style1">*</span>
                                                <asp:TextBox ID="txtSAID" CssClass="form-control" runat="server" MaxLength="13" placeholder="Enter SAID"></asp:TextBox>
                                            ...
                                            <div class="col-sm-1" style="padding: 0px; margin-top: 14px;">
                                                <asp:ImageButton ID="imgSearchsaid" runat="server" ImageUrl="~/assets/dist/img/search-icon.png" Height="35" Width="35" ToolTip="Search" ValidationGroup="Settler" OnClick="imgSearchsaid_Click" />
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="col-sm-3 form-group">
                                    ...
                                    <div class="panel-footer" style="border-top: 0px !important;">
                                        ...
                                        <asp:Button ID="btnCancel" runat="server" Visible="false" Text="Cancel" OnClick="btnCancel_Click" CssClass="btn btn-danger"></asp:Button>
                                            ...
                                            <div class="row" id="search" runat="server">
                                                <div class="col-lg-12">
                                                    <div class="col-lg-1 form-group">
                                                        <asp:DropDownList CssClass="form-control" ID="DropPage" runat="server"
                                ...
                                <div class="tab-pane fade" id="tabBank">
                                    ...
                                    <div class="panel-body">
                                        <div class="row" id="searchbank" runat="server">
                                            <div class="col-lg-12">
                                                <div class="col-lg-1 form-group">
                                                    <asp:DropDownList ID="dropBank" runat="server" CssClass="form-control" OnSelectedIndexChanged="dropBank_SelectedIndexChanged"
                                                        AutoPostBack="true">
                                                    </asp:DropDownList>
                                                </div>
                                                <div class="col-lg-2 form-group">
                                    ...
                                    <div class="col-md-12 form-group user-form-group">
                                        <div class="panel-body">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-8 form-group">
                                                    <label class="control-label">Settlor Name</label>
                                                    <asp:TextBox ID="txtSettlorNameAddress" runat="server" class="form-control" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="col-sm-4 form-group">
                                                 ...
                                                 <div class="col-sm-4 form-group">
                                                    ...
                                                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtSuburbName" Display="Dynamic" ErrorMessage="Enter Suburb Name"
                                                        ValidationGroup="Address" ForeColor="Red"></asp:RequiredFieldValidator>--%>
                                                </div>
                                                <div class="col-sm-4 form-group">
